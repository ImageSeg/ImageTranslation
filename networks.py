...
# opt.input_nc, opt.output_nc, opt.ngf, opt.xy_size
def define_G(input_nc, output_nc, ngf, xy_size, norm='batch', use_dropout=False, gpu_ids=[]):
    netG = None
    ...
    #print(input_nc, xy_size)
    #exit()
    netG = ResnetGenerator(input_nc+xy_size, output_nc, ngf, norm_layer=norm_layer, use_dropout=use_dropout, n_blocks=9, gpu_ids=gpu_ids)
